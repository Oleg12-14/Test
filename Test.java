...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        String[] symbols = value.split(" "); // symbols делит строку на элементы разделяя знаком в ""
        ...
        if (!isRoman) {
            //TODO работаем с арабскими числами
            ...
            //TODO работаем с римскими числами
    ...
    public static int workingWithRomanNumber(String[] val) {
        try {
            ...
            throw new NullPointerException("используются одновременно разные системы счисления");
        }
    }
